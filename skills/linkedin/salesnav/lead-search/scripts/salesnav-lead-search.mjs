...
const AUTH_CMD = 'node salesnav-lead-search.mjs auth';
 ...
 */
async function searchAllLeads(flags, { maxResults = 2500, pageSize = 25 } = {}) {
  let start = 0;
  let allLeads = [];
  let total = 0;
...
switch (command) {
  ...
  case 'search-profiles': {
    ...
    const searchResult = await searchAllLeads(flags, { maxResults, pageSize });
